...
def getDetail(image_info, urlbase):
    ...
    category = image_info.get('category', 'os') or "system"
...
def getImageList():
    ...
    for section in ini.sections():
        ...
        for image in parseSection(ini.items(section)):
            ...
            distro_to_section[image['distro']] = section
    ...
    raw = getJsonOutput(url_dict, prior)
    ret = {}
    for item in raw:
        ret[distro_to_section[item['display']]] = item
